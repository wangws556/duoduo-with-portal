...
namespace YoYoStudio.Controls.CustomWindow
{
    public class StandardWindow : Window
    {
        ...
        // This enables to use the YoYoStudio.Controls.CustomWindow in Visual Studio design mode. If DependencyProperties are used, the design mode does not work then.
